 ...
 *
 * 注意：必须用 IIFE 包裹，避免顶层 const GameCore 与游戏内联 class GameCore 冲突
 * （浏览器中 const+class 重名会报 SyntaxError "Identifier 'X' has already been declared"）
 * 通过 window.GameCore 暴露，避免污染全局词法环境
 */
...
(function() {
    ...
    // 暴露到 window（不污染全局词法环境，避免与内联 class GameCore 冲突）
